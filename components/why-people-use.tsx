const benefits = [
  {
    title: 'Stop wasting 20+ minutes searching',
    description: 'Find any file, note, or screenshot in under a second.',
    icon: (
  ...
  },
  {
    ...
    description: 'Every piece of information you save becomes part of a searchable knowledge base.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Instant AI-powered local search',
    description: 'Semantic search understands context, not just keywords.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'No cloud, no servers, no tracking. Your data never leaves your machine.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Works across PDFs, notes, screenshots, code',
    description: 'Index every format you work with. No limitations on file types.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function WhyPeopleUse() {
  return (
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="bg-secondary border border-border rounded-xl p-6 space-y-4 hover:border-accent/50 hover:bg-secondary/80 transition-all"
              >
                <div className="w-12 h-12 rounded-lg bg-background border border-border flex items-center justify-center text-foreground">
                  {benefit.icon}
                </div>
